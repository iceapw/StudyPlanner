...
namespace StudyPlanner.Models
{
    ...
    public class Root_Assignments
    {
        ...
        public bool hide_in_gradebook { get; set; }
        public bool omit_from_final_grade { get; set; }
        public bool suppress_assignment { get; set; }
        ...
        public object annotatable_attachment_id { get; set; }
        public string secure_params { get; set; }
        public string lti_context_id { get; set; }
        ...
        public bool graded_submissions_exist { get; set; }
        ...
        public object original_lti_resource_link_id { get; set; }
        public object original_assignment_name { get; set; }
        public object original_quiz_id { get; set; }
        ...
        public bool visible_to_everyone { get; set; }
        public bool locked_for_user { get; set; }
        public string submissions_download_url { get; set; }
        public bool post_manually { get; set; }
        public bool anonymize_students { get; set; }
        public bool new_quizzes_anonymous_participants { get; set; }
        public bool require_lockdown_browser { get; set; }
        public bool restrict_quantitative_data { get; set; }
    }
